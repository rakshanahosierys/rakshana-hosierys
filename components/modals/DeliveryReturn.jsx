        ...
        <div className="modal-content">
          ...
          <div className="overflow-y-auto">
            <div className="tf-product-popup-delivery">
              ...
              <p className="text-paragraph">
                Always free shipping for orders over INR ₹ 2000.
              </p>
              <p className="text-paragraph">
            ...
            <div className="tf-product-popup-delivery">
              ...
              <p className="text-paragraph">
                Email:{" "}
                <a
                  href="mailto:rakshanahosierys@gmail.com"
                  aria-describedby="a11y-external-message"
                >
                  <span className="__cf_email__">rakshanahosierys@gmail.com</span>
                </a>
              </p>
              <p className="text-paragraph mb-0">Phone: (+91) 94881 61177</p>
            </div>
          </div>
        </div>
      </div>
