      ...
      <div className="container">
        <div className="bg_grey-2 radius-10 flat-wrap-iconbox">
          <div className="flat-title lg">
            <span className="title fw-5">Where quality meets comfort</span>
            <div>
              <p className="sub-title text_black-2">
                At Classy Fox, our expert stylists curate outfits perfect for every season and moment
              </p>
              <p className="sub-title text_black-2">
                from playful kidswear to elegant maternity essentials.
              </p>
            </div>
          </div>
