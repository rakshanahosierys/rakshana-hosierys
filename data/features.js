...
export const iconBoxes4 = [
  {
    ...
    description:
      "Crafted with care, our clothing is made from high-quality, breathable materials — built for comfort, style, and durability.",
  },
  {
    iconClass: "icon-design",
    title: "Refined Designs",
    description:
      "Simple. Stylish. Timeless. Our pieces blend modern minimalism with thoughtful detailing to elevate everyday fashion.",
  },
  {
    iconClass: "icon-sizes",
    title: "Inclusive Sizing",
    description:
      "We celebrate every shape and stage — offering a wide range of sizes for women, moms-to-be, and little trendsetters.",
  },
];
