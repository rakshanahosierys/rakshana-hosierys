...
export const shopLinks = [
  { href: "/shop-default", text: "Women" },
  { href: "/shop-default", text: "Men" },
  { href: "/shop-default", text: "Boys" },
  { href: "/shop-default", text: "Girls" },
  { href: "/shop-default", text: "Maternity Wear" },
];

export const contactLinks = [
  { href: "/contact-us", text: "Contact" },
  { href: "/reach-out", text: "Reach Out" },
  { href: "/store-locations", text: "Store Locations" },
];
...
export const navItems = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/shop-default", label: "Women" },
      { href: "/shop-default", label: "Men" },
      { href: "/shop-default", label: "Boys" },
      { href: "/shop-default", label: "Girls" },
    ],
  },
  {
